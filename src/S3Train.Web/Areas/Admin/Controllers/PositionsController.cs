...
namespace S3Train.Web.Areas.Admin.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NamePosition,CreatedDate,UpdatedDate,IsActive")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NamePosition,CreatedDate,UpdatedDate,IsActive")] Position position)
        {
            if (ModelState.IsValid)
            {
